...
mark_as_advanced(PC_GST_INC_DIRS PC_GST_LIBS PC_GST_LIB_DIRS)

if(${PC_GSTREAMER_FOUND})
    find_library(GSTREAMER_LIBRARY gstreamer-1.0
        HINTS ${PC_GST_LIB_DIRS}
    )

    set(GSTREAMER_LIBRARIES ${PC_GST_LIBS})
    set(GSTREAMER_INCLUDES ${PC_GST_INC_DIRS})
    ...
    if(NOT TARGET GStreamer::GStreamer)
        ...
        set_target_properties(GStreamer::GStreamer
                ...
                INTERFACE_INCLUDE_DIRECTORIES "${PC_GST_INC_DIRS}"
                INTERFACE_LINK_LIBRARIES "${PC_GST_LIBS}"
                )
    endif()
endif()
